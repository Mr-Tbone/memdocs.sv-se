...
|:---:|:---:|:---:|:---:|:---:|:---:|
|**Administratör för Android-enhet**|**Användarinitierat via företagsportalen** | Nej | Ja | Nej | [Mer information](https://docs.microsoft.com/user-help/enroll-device-android-company-portal)|
