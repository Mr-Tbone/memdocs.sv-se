...
> [!IMPORTANT]
> - Leverans optimering måste vara aktive rad (standard) och inte kringgås. Mer information finns i [referens för Windows Delivery Optimization](/windows/deployment/update/waas-delivery-optimization-reference).
...
Mer information om nätverks portar, proxy-krav och värdnamn för brand väggar finns i [vanliga frågor och svar om leverans optimering](/windows/deployment/update/waas-delivery-optimization#frequently-asked-questions).
