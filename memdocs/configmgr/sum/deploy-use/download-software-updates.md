---
title: 'Hämta programuppdateringar '
titleSuffix: Configuration Manager
description: Använd guiden hämta program uppdateringar för att ladda ned program uppdateringar och distribuera dem till distributions platser så att de är klara att distribueras till klienter.
ms.date: 01/23/2017
ms.topic: conceptual
...
ms.locfileid: "81719087"
---
# <a name="download-software-updates"></a>Hämta programuppdateringar  

*Gäller för: Configuration Manager (aktuell gren)*

Det finns flera metoder som du kan använda för att ladda ned program uppdateringar i Configuration Manager. När du skapar en automatisk distributions regel (ADR) eller distribuerar program uppdateringar manuellt, laddas program uppdateringarna ned till innehålls biblioteket på plats servern. Därefter kopieras program uppdateringarna till innehålls biblioteket på de distributions platser som är associerade med det konfigurerade distributions paketet. Om du vill ladda ned programuppdateringar innan du distribuerar dem kan du använda guiden Hämta uppdateringar. Om du gör detta kan du verifiera att programuppdateringarna är tillgängliga på distributionsplatser innan du distribuerar programuppdateringarna till klientdatorerna.  

> [!NOTE]  
>  Information om övervakning av innehållsstatus finns i avsnittet [Övervakning av innehållsstatus](../deploy-use/monitor-software-updates.md#BKMK_ContentStatus).  

Använd följande procedur för att ladda ned programuppdateringar genom att använda guiden Hämta programuppdateringar.  

#### <a name="to-download-software-updates"></a>Ladda ned programuppdateringar  
