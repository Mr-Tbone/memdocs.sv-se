...
description: Granska Office 365-klient information från instrument panelen för Office 365-klient hantering
author: mestew
ms.author: mstewart
manager: dougeby
ms.date: 04/21/2020
...
Från och med Configuration Manager version 1802 kan du granska Office 365-klient information från instrument panelen för Office 365-klient hantering. Instrument panelen för Office 365-klient hantering visar en lista över relevanta enheter när diagram avsnitt har marker ATS. <!--1357281 -->

## <a name="prerequisites"></a>Krav

### <a name="enable-hardware-inventory"></a>Aktivera maskin varu inventering
...
### <a name="enable-data-collection-for-office-365-proplus"></a>Aktivera data insamling för Office 365 ProPlus

*(Lanseras i version 1910 som ett krav)*

Från och med version 1910 måste du aktivera data insamling för Office 365 ProPlus för att fylla i informationen i **instrument panelen för office 365 ProPlus pilot och hälso tillstånd**. Data lagras i Configuration Manager plats databasen och skickas inte till Microsoft.

Dessa data skiljer sig från diagnostikdata, som beskrivs i [diagnostikdata som skickas från Office 365 ProPlus till Microsoft](https://docs.microsoft.com/deployoffice/privacy/overview-privacy-controls#diagnostic-data-sent-from-office-365-proplus-to-microsoft).
...
Om du vill visa instrument panelen för Office 365-klient hantering i Configuration Manager-konsolen går du till **program bibliotek** > **Översikt** > **kontor 365 klient hantering**. Överst på instrument panelen använder du List rutan **samling** för att filtrera instrument panels data efter medlemmar i en angiven samling. Från och med Configuration Manager version 1802 visar instrument panelen för Office 365-klient hantering en lista över relevanta enheter när diagram avsnitt har marker ATS.
...
- Office 365-klient kanaler mer information finns i [Översikt över uppdaterings kanaler för Office 365 ProPlus](/DeployOffice/overview-of-update-channels-for-office-365-proplus).


## <a name="integration-for-office-365-proplus-readiness"></a><a name="bkmk_o365_readiness"></a>Integrering för Office 365 ProPlus-beredskap
<!--3735402-->
Från och med Configuration Manager version 1902 kan du använda instrument panelen för att identifiera enheter med hög exakthet som är klara att uppgradera till Office 365 ProPlus. Den här integrationen ger insikter om potentiella kompatibilitetsproblem med Office-tillägg och makron i din miljö. Använd sedan Configuration Manager för att distribuera Office till färdiga enheter.
...
### <a name="prerequisites-for-office-365-proplus-readiness-integration"></a>Krav för integrering med Office 365 ProPlus readiness
...
## <a name="office-365-proplus-upgrade-readiness-dashboard"></a><a name="bkmk_readiness-dash"></a>Instrument panel för Office 365 ProPlus Upgrade readiness

*(Lanseras i version 1906)*

<!--4021125-->
För att hjälpa dig att avgöra vilka enheter som är klara att uppgradera till Office 365 ProPlus, finns det en beredskaps instrument panel som börjar i version 1906. Den innehåller panelen **Office 365 ProPlus Upgrade readiness** som släpptes i Configuration Manager aktuella gren versionen 1902. Följande nya paneler på den här instrument panelen hjälper dig att utvärdera Office-tillägget och makro beredskap:
...
### <a name="using-the-office-365-proplus-upgrade-readiness-dashboard"></a>Använda instrument panelen för Office 365 ProPlus Upgrade readiness
...
1. Välj noden **Office 365 ProPlus uppgraderingsberedskap** .
...
Om du väljer kategorin **klar att uppgradera** i diagrammet visas mer information om enheterna i den begränsande samlingen. Du kan granska enhets listan, göra val enligt dina affärs behov och skapa en ny enhets samling från ditt val. Använd din nya samling för att distribuera Office 365 ProPlus med Configuration Manager.

Enheter som kan vara utsatta för kompatibilitetsproblem markeras som **behovs granskning**. Dessa enheter kan behöva vidta åtgärder innan de uppgraderas till Office 365 ProPlus. Du kan till exempel uppdatera viktiga tillägg till en senare version.

### <a name="add-in-information"></a>Information om tillägg

 En inventering av alla installerade tillägg samlas in på varje enhet. Inventeringen jämförs sedan med den information som Microsoft har om tilläggs prestandan för Office 365 ProPlus. Om det finns ett tillägg som sannolikt kommer att orsaka problem efter uppgraderingen, är alla enheter med tillägget flaggade för granskning.
...
Från och med version 1910 kan du planera, pilot och utföra din Office 365 ProPlus-distribution med hjälp av **instrument panelen för office 365 ProPlus pilot och hälso tillstånd** . Instrument panelen tillhandahåller hälso insikter för enheter med Office 365 ProPlus för att identifiera möjliga problem som kan påverka dina distributions planer. **Instrument panelen för Office 365 ProPlus pilot och hälso tillstånd** innehåller en rekommendation för pilotbaserade enheter som baseras på inventering av tillägg. Följande paneler finns på instrument panelen:
...
[Hantera Office 365 ProPlus med Configuration Manager](manage-office-365-proplus-updates.md)
