...
-   Mer information om minimi kraven för WSUS-serverrollen i Windows Server finns i [Granska överväganden och system krav](/windows-server/administration/windows-server-update-services/plan/plan-your-wsus-deployment#11-review-considerations-and-system-requirements).  
...
Mer information om hur du installerar WSUS på Windows Server finns i [Installera WSUS-serverrollen](/windows-server/administration/windows-server-update-services/deploy/1-install-the-wsus-server-role).  
