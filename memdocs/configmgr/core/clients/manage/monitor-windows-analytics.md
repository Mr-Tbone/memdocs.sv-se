---
title: Övervaka klienter med Windows Analytics
titleSuffix: Configuration Manager
description: Windows Analytics är en uppsättning lösningar som gör att du kan rita värdefulla insikter i miljöns aktuella tillstånd.
ms.date: 01/31/2020
...
Om din Configuration Manager plats hade en anslutning till Uppgraderingsberedskap måste du ta bort den och konfigurera om klienter. Mer information finns i [ta bort uppgraderingsberedskap anslutning](upgrade-readiness.md#bkmk_remove).
