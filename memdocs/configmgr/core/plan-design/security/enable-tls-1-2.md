...
|Gateway för molnhantering|[Aktivera TLS 1.2](../../clients/manage/cmg/security-and-privacy-for-cloud-management-gateway.md#bkmk_tls)|
...
- [Metod tips för TLS (Transport Layer Security) med .NET Framework](/dotnet/framework/network-programming/tls#configuring-security-via-the-windows-registry)
