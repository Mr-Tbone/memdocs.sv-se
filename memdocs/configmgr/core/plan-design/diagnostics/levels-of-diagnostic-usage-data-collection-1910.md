---
title: Diagnostik-och användnings data för 1910
titleSuffix: Configuration Manager
description: Läs mer om vilka data som Configuration Manager samlar in på varje nivå i version 1910.
ms.date: 11/29/2019
...
ms.locfileid: "88994522"
---
# <a name="diagnostic-and-usage-data-for-version-1910"></a>Diagnostik-och användnings data för version 1910
...
För Configuration Manager version 1910 omfattar den här nivån följande data:
...
- ***[Ny]*** Antal Microsoft Edge-installationer
...
- ***[Ny]*** Sammanställd statistik för hälso tillstånd för Office-tillägg

- ***[Ny]*** Antal och storlek på Office Pro plus pilot samlingar
...
- ***[Ny]*** Användning av Azure Migration Tool
