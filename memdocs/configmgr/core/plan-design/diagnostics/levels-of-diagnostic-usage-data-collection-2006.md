---
title: Diagnostik-och användnings data för 2006
titleSuffix: Configuration Manager
description: Läs mer om vilka data som Configuration Manager samlar in på varje nivå i version 2006.
ms.date: 08/11/2020
...
ms.locfileid: "88129709"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>Diagnostik-och användnings data för version 2006
...
För Configuration Manager version 2006 omfattar den här nivån följande data:
...
- Grundläggande Configuration Manager webbplatsens hierarki data: plats lista, typ, version, status, antal klienter, tidszon och hälso status
...
- Information om plats hälsa

- Configuration Manager konsol krasch platser

- Configuration Manager användnings statistik för konsolen

- Åtgärder för att ansluta och koppla från molnet

- Status för senaste synkronisering med Intunes moln tjänst

- Antal fel från administrations tjänsten

- Användning av token för Mass registrering

- Antal klienter som standard och önskad webbläsare

- ***[Flyttad]*** Konfiguration och användnings statistik för Cloud Management Gateway: antal regioner och miljöer samt statistik över autentisering/auktorisering  

- ***[Flyttad]*** SQL AlwaysOn-replikerad information, användning och hälso status  

- ***[Ny]*** Aviserings konfiguration och status för administratörs konsolen

- ***[Ny]*** Konfiguration och status för plats hälso kontroll
...
- Antal Microsoft 365 Apps-program som skapats med instrument panelen  
...
- Sammanställd statistik för Office-tillägg, användning av Office readiness Toolkit och antalet klienter med Microsoft 365 appar

- Sammanställd statistik för hälso tillstånd för Office-tillägg

- Antal och storlek på Office Pro plus pilot samlingar

- Antal Office Pro plus-enheter som skickar hälso data för Office
...
- ***[Uppdaterat]***  -  ***[Ny]*** program varu inventerings regler, fil insamlings regler och övergripande hälso status
...
- ***[Ny]*** Sammanfattat antal slut punkts analys händelser
...
- Användning av guiden Cloud Services onboarding
...
- ***[Ny]*** Antal kompatibilitetsinställningar som distribueras av kategori, OS och källa (molnet eller lokalt)
...
- Konsol prestanda information

- 25 de vanligaste åtgärderna, guider, egenskaps blad och trädnod som nås i-konsolen
...
- Antal undernät som exkluderats från peer-cache
...
- Sammanställd statistik för Microsoft Defender Avancerat skydd-principer
...
- Antal distribuerade Microsoft 365 uppdateringar av appar  
...
- Användning av Dirigerings grupp

- Windows Update inställningar för återställnings konfiguration
...
- Status för senaste ominitierings begär Anden
...
- Antal klienter med webb läsar användning
