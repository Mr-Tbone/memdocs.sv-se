---
title: Teknisk för hands version 2007
titleSuffix: Configuration Manager
description: Lär dig mer om nya funktioner som är tillgängliga i Configuration Manager Technical Preview Branch version 2007.
ms.date: 07/14/2020
...
ms.locfileid: "86385088"
---
# <a name="features-in-configuration-manager-technical-preview-version-2007"></a>Funktioner i Configuration Manager Technical Preview version 2007

*Gäller för: Configuration Manager (Technical Preview Branch)*

Den här artikeln beskriver de funktioner som är tillgängliga i den tekniska för hands versionen för Configuration Manager version 2007. Installera den här versionen om du vill uppdatera och lägga till nya funktioner till din tekniska för hands versions webbplats.
