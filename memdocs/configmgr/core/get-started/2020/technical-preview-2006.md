---
title: Teknisk för hands version 2006
titleSuffix: Configuration Manager
description: Lär dig mer om nya funktioner som är tillgängliga i Configuration Manager Technical Preview Branch version 2006.
ms.date: 06/29/2020
...
ms.locfileid: "85590547"
---
# <a name="features-in-configuration-manager-technical-preview-version-2006"></a>Funktioner i Configuration Manager Technical Preview version 2006

*Gäller för: Configuration Manager (Technical Preview Branch)*

Den här artikeln beskriver de funktioner som är tillgängliga i den tekniska för hands versionen för Configuration Manager version 2006. Installera den här versionen om du vill uppdatera och lägga till nya funktioner till din tekniska för hands versions webbplats.
