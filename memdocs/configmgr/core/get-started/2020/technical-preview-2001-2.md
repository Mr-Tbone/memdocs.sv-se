---
title: Teknisk för hands version 2001,2
titleSuffix: Configuration Manager
description: Lär dig mer om nya funktioner som är tillgängliga i Configuration Manager Technical Preview Branch version 2001,2.
ms.date: 02/03/2020
...
ms.locfileid: "81712017"
---
# <a name="features-in-configuration-manager-technical-preview-version-20012"></a>Funktioner i Configuration Manager Technical Preview version 2001,2

*Gäller för: Configuration Manager (Technical Preview Branch)*

Den här artikeln beskriver de funktioner som är tillgängliga i den tekniska för hands versionen för Configuration Manager version 2001,2. Installera den här versionen om du vill uppdatera och lägga till nya funktioner till din tekniska för hands versions webbplats.
...
## <a name="general-known-issues"></a>Allmänna kända problem
