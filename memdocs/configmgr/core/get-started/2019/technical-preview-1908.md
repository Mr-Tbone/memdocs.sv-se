---
title: Teknisk för hands version 1908
titleSuffix: Configuration Manager
description: Lär dig mer om nya funktioner som är tillgängliga i Configuration Manager Technical Preview Branch version 1908.
ms.date: 08/06/2019
...
ms.locfileid: "81716077"
---
# <a name="features-in-configuration-manager-technical-preview-version-1908"></a>Funktioner i Configuration Manager Technical Preview version 1908

*Gäller för: Configuration Manager (Technical Preview Branch)*

Den här artikeln beskriver de funktioner som är tillgängliga i den tekniska för hands versionen för Configuration Manager version 1908. Installera den här versionen om du vill uppdatera och lägga till nya funktioner till din tekniska för hands versions webbplats.
