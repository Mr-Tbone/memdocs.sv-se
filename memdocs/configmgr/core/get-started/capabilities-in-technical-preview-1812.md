---
title: Teknisk för hands version 1812
titleSuffix: Configuration Manager
description: Lär dig mer om nya funktioner som är tillgängliga i Configuration Manager Technical Preview Branch version 1812.
ms.date: 12/14/2018
...
ms.locfileid: "81713186"
---
# <a name="capabilities-in-configuration-manager-technical-preview-version-1812"></a>Funktioner i Configuration Manager Technical Preview version 1812 

*Gäller för: Configuration Manager (Technical Preview Branch)*

Den här artikeln beskriver de funktioner som är tillgängliga i den tekniska för hands versionen för Configuration Manager version 1812. Installera den här versionen om du vill uppdatera och lägga till nya funktioner till din tekniska för hands versions webbplats. 
