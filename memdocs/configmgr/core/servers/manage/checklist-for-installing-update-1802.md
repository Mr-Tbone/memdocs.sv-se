...
När du använder den aktuella grenen av Configuration Manager kan du installera uppdatering i konsolen för version 1802 för att uppdatera din hierarki från en tidigare version. <!-- baseline only statement: -->(Eftersom version 1802 också är tillgängligt som [bas linje medium](updates.md#bkmk_Baselines)kan du använda installations mediet för att installera den första platsen i en ny hierarki.)
