---
title: Felsöka CMPivot
titleSuffix: Configuration Manager
description: Lär dig hur du felsöker CMPivot i Configuration Manager.
ms.date: 10/07/2019
...
CMPivot är ett verktyg som ger åtkomst till en real tids status för enheterna i din miljö. CMPivot kör en fråga på alla just nu anslutna enheter i mål samlingen och returnerar resultatet.

Ibland kan du behöva felsöka CMPivot. Om ett tillstånds meddelande från en klient till CMPivot blir skadat, kan plats servern inte bearbeta meddelandet. Den här artikeln hjälper dig att förstå informations flödet för CMPivot.

## <a name="troubleshoot-cmpivot-in-version-1902-and-later"></a><a name="bkmk_CMPivot-1902"></a>Felsöka CMPivot i version 1902 och senare
...
> [!TIP]
> Om du får ett undantag under bearbetningen kan du granska det genom att köra följande SQL-fråga och titta i kolumnen undantag. När meddelandet har bearbetats kommer det inte längre att finnas i `MPE_RequestMessages_Instant` tabellen.
>
> ```SQL
...
I Configuration Manager version 1810 och tidigare hanterar plats servern kommunikationen till klienten.
...
>[!NOTE]
>För klienter som använder version 1810 eller senare används inte tillstånds meddelanden om inte utdata är större än 80 KB. När du felsöker CMPivot i dessa fall kan du få mer information när du aktiverar utförlig loggning på ditt MP och plats serverns SMS_MESSAGE_PROCESSING_ENGINE. Information om hur du aktiverar utförlig loggning finns i alternativ för [plats Server loggning](../../plan-design/hierarchy/about-log-files.md#bkmk_reg-site).
>
> Fel sökning finns i följande loggar:
>
> - `MP_Relay.log`
