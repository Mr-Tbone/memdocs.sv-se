...
- [Uppgraderings-och konverterings alternativ för Windows Server 2016](/windows-server/get-started/supported-upgrade-paths)  

- [Uppgraderings alternativ för Windows Server 2012 R2](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn303416(v=ws.11))  
...
När du har uppgraderat en server som är värd för en plats system roll `Software\Microsoft\SMS` kan värdet saknas i följande register nyckel: `HKLM\SYSTEM\CurrentControlSet\Control\SecurePipeServers\Winreg\AllowedPaths`
...
Mer information om kompatibilitetsnivån för SQL CE och hur du ställer in dem finns i [Alter Database Compatibility Level (Transact-SQL)](/sql/t-sql/statements/alter-database-transact-sql-compatibility-level?view=sql-server-2017).

Mer information om hur du uppgraderar SQL Server finns i följande SQL Server artiklar:  

- [Uppgradera till SQL Server 2017](/sql/database-engine/install-windows/supported-version-and-edition-upgrades-2017)  

- [Uppgradera till SQL Server 2016](/sql/database-engine/install-windows/supported-version-and-edition-upgrades?view=sql-server-2016)  

- [Uppgradera till SQL Server 2014](/sql/database-engine/install-windows/supported-version-and-edition-upgrades?view=sql-server-2014)  
